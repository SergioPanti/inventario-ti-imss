            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">EDITAR EQUIPsadasd</h1>
                            ...
                            <div class="row text-lg-start">
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="hidden" class="form-control" name="equipoAnterior" id=""
                                        aria-describedby="helpId" placeholder="" value="{{ $q->registroid }}">
                                    </div>
                                </div>
