                        ...
                        <form action="{{ route('crear-registro') }}" method="post">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row text-lg-start text-sm-start">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-1">
                                            <label for="" class="form-label text-success">Equipoasdasd</label>
                                            <select class="form-control form-select" name="equipo" id="">
                                                <option selected> Selecciona un equipo jhgjghj</option>
...
<div class="modal fade" id="create" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">NUEVO RESPONSABLEsdasdas</h1>
            ...
            <form action="{{ route('crear-registro') }}" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="row text-lg-start text-sm-start">
                        ...
                        <div class="col-lg-12">
                            <div class="mb-1">
                                <label for="" class="form-label text-success">Equipoxxx</label>
                                <select class="form-control form-select" name="equipo" id="">
                                    ...
                                    @if($e->availability == 0)
                                    {
                                        <option value="{{ $e->equipoid }}">
                                            NNI: {{ $e->nni }} -
                                            MODELOss: "{{ $e->nombremarca }} {{ $e->nombremodelo }}"
                                        </option>
                                    }
                                    @endif
                                    @endforeach
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cancelasdasdar</button>
                        <button type="submit" class="btn btn-success">Agregar</button>
                    </div>
            </form>
        </div>
